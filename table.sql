...
CREATE TABLE `esakip_data_rencana_aksi_opd` (
  ...
  `id_cascading` text DEFAULT NULL,
...
CREATE TABLE `esakip_data_rencana_aksi_indikator_opd` (
  ...
  `rencana_pagu_rhk` double(20, 2) DEFAULT NULL,
  `realisasi_pagu` double(20, 2) DEFAULT NULL,
  ...
  `rumus_capaian_kinerja` TINYINT(4) DEFAULT 1 NOT NULL COMMENT '1 = Tren Positif, 2 = Nilai Akhir, 3 = Tren Negatif',
  `id_indikator_cascading` int(11) DEFAULT NULL,
...
CREATE TABLE `esakip_finalisasi_tahap_laporan_pk` (
  ...
  `nama_pegawai` TEXT NOT NULL,
  `pangkat_pegawai` TEXT DEFAULT NULL,
  `jabatan_pegawai` TEXT NOT NULL,
  `nama_pegawai_atasan` TEXT NOT NULL,
  `nip_pegawai_atasan` TEXT DEFAULT NULL,
  `pangkat_pegawai_atasan` TEXT DEFAULT NULL,
  `jabatan_pegawai_atasan` TEXT NOT NULL,
...
CREATE TABLE esakip_laporan_pk_pemda (
  ...
  `target_teks` VARCHAR(255) DEFAULT NULL,
  `realisasi_1` DECIMAL(10,2) DEFAULT NULL,
  `realisasi_2` DECIMAL(10,2) DEFAULT NULL,
  `realisasi_3` DECIMAL(10,2) DEFAULT NULL,
  `realisasi_4` DECIMAL(10,2) DEFAULT NULL,
  `realisasi_teks_1` VARCHAR(255) DEFAULT NULL,
  `realisasi_teks_2` VARCHAR(255) DEFAULT NULL,
  `realisasi_teks_3` VARCHAR(255) DEFAULT NULL,
  `realisasi_teks_4` VARCHAR(255) DEFAULT NULL,
  `satuan` text DEFAULT NULL,
  `id_jadwal` int(11) DEFAULT NULL,
  `pagu` double(20, 0) DEFAULT NULL,
  `tahun_anggaran` year(4) DEFAULT null,
  `is_hidden` TINYINT(4) DEFAULT 2 NOT NULL COMMENT '1 = True (disembunyikan), 2 = False',
  `is_target_teks` TINYINT(4) DEFAULT 2 NOT NULL COMMENT '1 = True (Teks), 2 = False',
  `rumus_capaian_kinerja` TINYINT(4) DEFAULT 1 NOT NULL COMMENT '1 = Tren Positif, 2 = Nilai Akhir, 3 = Tren Negatif',
  `active` tinyint(4) NOT NULL DEFAULT '1',
  PRIMARY KEY  (`id`),
  KEY `id_iku` (`id_iku`),
...
CREATE TABLE `esakip_finalisasi_tahap_pk_pemda` (
  `id` int(11) NOT NULL auto_increment,
  `nama_tahapan` text DEFAULT NULL,
  `tanggal_dokumen` date DEFAULT NULL,
  `id_jadwal` int(11) DEFAULT NULL,
...
CREATE TABLE `esakip_finalisasi_pk_pemda` (
  `id` int(11) NOT NULL auto_increment,
  `id_tahap` varchar(255) DEFAULT null,
  `label_sasaran` text DEFAULT null,
  `label_indikator` text DEFAULT null,
...
CREATE TABLE `esakip_detail_rencana_aksi_pemda` (
  `id` int(11) NOT NULL auto_increment,
  `id_pk` varchar(255) DEFAULT null,
  `id_skpd` int(11) DEFAULT NULL,
  `id_jadwal` int(11) DEFAULT NULL,
  `tahun_anggaran` year(4) DEFAULT null,
  `active` tinyint(4) NOT NULL,
