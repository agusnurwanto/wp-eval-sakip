...
<script>
	...
	function getTableSkpd() {
		...
		jQuery.ajax({
			...
			type: 'POST',
			data: {
				action: 'get_table_skpd_pengukuran_rencana_aksi',
				api_key: esakip.api_key,
    ...
    function hapus_tahun_dokumen_pengukuran_rencana_aksi(id) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'hapus_tahun_dokumen_pengukuran_rencana_aksi',
                api_key: esakip.api_key,
                id: id
            },
            dataType: 'json',
