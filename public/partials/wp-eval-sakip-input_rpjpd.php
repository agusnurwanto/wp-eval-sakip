...
foreach ($data_all['data'] as $visi) {
    ...
    $body .= '
		<tr class="tr-visi">
			<td class="esakip-kiri esakip-atas esakip-kanan esakip-bawah">' . $no_visi . '</td>
			<td class="esakip-atas esakip-kanan esakip-bawah">' . $visi['nama'] . button_edit_monev($visi['detail'][0]['id']) . '</td>
    ...
    foreach ($visi['data'] as $misi) {
        ...
        $body .= '
			<tr class="tr-misi">
				<td class="esakip-kiri esakip-esakip-atas esakip-kanan esakip-bawah">' . $no_visi . '.' . $no_misi . '</td>
				<td class="esakip-atas esakip-kanan esakip-bawah"><span class="debug-visi">' . $visi['nama'] . '</span></td>
				<td class="esakip-atas esakip-kanan esakip-bawah">' . $misi['nama'] . button_edit_monev($visi['detail'][0]['id'] . '-' . $misi['detail'][0]['id']) . '</td>
				<td class="esakip-atas esakip-kanan esakip-bawah"></td>
				<td class="esakip-atas esakip-kanan esakip-bawah"></td>
				<td class="esakip-atas esakip-kanan esakip-bawah"></td>
			</tr>
        ...
        foreach ($misi['data'] as $sasaran) {
            ...
            $body .= '
				<tr class="tr-sasaran">
					<td class="esakip-kiri esakip-atas esakip-kanan esakip-bawah">' . $no_visi . '.' . $no_misi . '.' . $no_sasaran . '</td>
					<td class="esakip-atas esakip-kanan esakip-bawah"><span class="debug-visi">' . $visi['nama'] . '</span></td>
					<td class="esakip-atas esakip-kanan esakip-bawah"><span class="debug-misi">' . $misi['nama'] . '</span></td>
					<td class="esakip-atas esakip-kanan esakip-bawah">' . $sasaran['nama'] . button_edit_monev($visi['detail'][0]['id'] . '-' . $misi['detail'][0]['id'] . '-' . $sasaran['detail'][0]['id']) . '</td>
					<td class="esakip-atas esakip-kanan esakip-bawah"></td>
					<td class="esakip-atas esakip-kanan esakip-bawah"></td>
				</tr>
			';
            ...
            foreach ($sasaran['data'] as $kebijakan) {
                ...
                $body .= '
					<tr class="tr-kebijakan">
						<td class="esakip-kiri esakip-atas esakip-kanan esakip-bawah">' . $no_visi . '.' . $no_misi . '.' . $no_sasaran . '.' . $no_kebijakan . '</td>
						<td class="esakip-atas esakip-kanan esakip-bawah"><span class="debug-visi">' . $visi['nama'] . '</span></td>
						<td class="esakip-atas esakip-kanan esakip-bawah"><span class="debug-misi">' . $misi['nama'] . '</span></td>
						<td class="esakip-atas esakip-kanan esakip-bawah"><span class="debug-sasaran">' . $sasaran['nama'] . '</span></td>
						<td class="esakip-atas esakip-kanan esakip-bawah">' . $kebijakan['nama'] . button_edit_monev($visi['detail'][0]['id'] . '-' . $misi['detail'][0]['id'] . '-' . $sasaran['detail'][0]['id'] . '-' . $kebijakan['detail'][0]['id']) . '</td>
						<td class="esakip-atas esakip-kanan esakip-bawah"></td>
					</tr>
				';
                $no_isu = 0;
                foreach ($kebijakan['data'] as $isu) {
                    ...
                    $body .= '
						<tr class="tr-isu">
							<td class="esakip-kiri esakip-atas esakip-kanan esakip-bawah">' . $no_visi . '.' . $no_misi . '.' . $no_sasaran . '.' . $no_kebijakan . '.' . $no_isu . '</td>
							<td class="esakip-atas esakip-kanan esakip-bawah"><span class="debug-visi">' . $visi['nama'] . '</span></td>
							<td class="esakip-atas esakip-kanan esakip-bawah"><span class="debug-misi">' . $misi['nama'] . '</span></td>
							<td class="esakip-atas esakip-kanan esakip-bawah"><span class="debug-sasaran">' . $sasaran['nama'] . '</span></td>
							<td class="esakip-atas esakip-kanan esakip-bawah"><span class="debug-kebijakan">' . $kebijakan['nama'] . '</span></td>
							<td class="esakip-atas esakip-kanan esakip-bawah">' . $isu['nama'] . button_edit_monev($visi['detail'][0]['id'] . '-' . $misi['detail'][0]['id'] . '-' . $sasaran['detail'][0]['id'] . '-' . $kebijakan['detail'][0]['id'] . '-' . $isu['detail'][0]['id']) . '</td>
						</tr>
					';
                }
            }
    ...
    <table cellpadding="2" cellspacing="0" style="font-family:\'Open Sans\',-apple-system,BlinkMacSystemFont,\'Segoe UI\',sans-serif; border-collapse: collapse; font-size: 70%; border: 0; table-layout: fixed;" contenteditable="false">
        <thead>
            <tr>
                ...
                <th style="width: 200px;" class="esakip-atas esakip-kanan esakip-bawah esakip-text_tengah esakip-text_blok">Visi</th>
                <th style="width: 200px;" class="esakip-atas esakip-kanan esakip-bawah esakip-text_tengah esakip-text_blok">Misi</th>
                <th style="width: 200px;" class="esakip-atas esakip-kanan esakip-bawah esakip-text_tengah esakip-text_blok">Sasaran</th>
                <th style="width: 200px;" class="esakip-atas esakip-kanan esakip-bawah esakip-text_tengah esakip-text_blok">Kebijakan</th>
                <th style="width: 200px;" class="esakip-atas esakip-kanan esakip-bawah esakip-text_tengah esakip-text_blok">Isu</th>
            </tr>
            <tr>
                <th class='esakip-atas esakip-kiri esakip-kanan esakip-bawah esakip-text_tengah esakip-text_blok'>0</th>
                <th class='esakip-atas esakip-kanan esakip-bawah esakip-text_tengah esakip-text_blok'>1</th>
                <th class='esakip-atas esakip-kanan esakip-bawah esakip-text_tengah esakip-text_blok'>2</th>
                <th class='esakip-atas esakip-kanan esakip-bawah esakip-text_tengah esakip-text_blok'>3</th>
                <th class='esakip-atas esakip-kanan esakip-bawah esakip-text_tengah esakip-text_blok'>4</th>
                <th class='esakip-atas esakip-kanan esakip-bawah esakip-text_tengah esakip-text_blok'>5</th>
            </tr>
        </thead>
        <tbody>
            <?php echo $body; ?>
        ...
        jQuery('#singkron-sipd').on('click', function() {
            if (confirm('Apakah anda yakin untuk mengambil data dari SIPD lokal? data lama akan diupdate!')) {
                ...
                jQuery.ajax({
                    ...
                    type: "post",
                    data: {
                        "action": "esakip_singkron_rpjpd_sipd_lokal",
