...
$tipe_dokumen = "evaluasi_internal";
...
<div class="container-md">
    <div class="cetak">
        <div style="padding: 10px;margin:0 0 3rem 0;">
            <h1 class="text-center" style="margin:3rem;">Dokumen Evaluasi Internal <br>Pemerintah Daerah<br> Tahun Anggaran <?php echo $input['tahun']; ?></h1>
