...
$tipe_dokumen = "tl_lhe_akip_kemenpan";
...
<div class="container-md">
    <div class="cetak">
        <div style="padding: 10px;margin:0 0 3rem 0;">
            <h1 class="text-center" style="margin:3rem;">Dokumen TL LHE Akip Kemenpan <br>Pemerintah Daerah<br> Tahun Anggaran <?php echo $input['tahun']; ?></h1>
    ...
    function getTableDokumen() {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                nama_tabel_database: 'esakip_tl_lhe_akip_kemenpan_pemda'
            },
            dataType: 'json',
