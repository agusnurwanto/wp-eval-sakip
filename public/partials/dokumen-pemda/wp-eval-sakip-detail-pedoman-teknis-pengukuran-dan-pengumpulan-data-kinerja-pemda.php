...
<div class="container-md">
    <div class="cetak">
        <div style="padding: 10px;margin:0 0 3rem 0;">
            <h1 class="text-center" style="margin:3rem;">Dokumen Pedoman Teknis Pengukuran dan Pengumpulan Data Kinerja<br>Pemerintah Daerah<br> Tahun Anggaran <?php echo $input['tahun']; ?></h1>
    ...
    function getTableDokumen() {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                nama_tabel_database: 'esakip_pedoman_teknis_pengukuran_dan_p_d_k_pemda'
            },
            dataType: 'json',
