...
<div class="container-md">
    <div class="cetak">
        <div style="padding: 10px;margin:0 0 3rem 0;">
            <h1 class="text-center" style="margin:3rem;">Dokumen Rencana Aksi <br>Pemerintah Daerah<br> Tahun Anggaran <?php echo $input['tahun']; ?></h1>
        ...
        if(list.length){
            ...
            jQuery.ajax({
                ...
                data: {
                    ...
                    list: list,
                    tahun_anggaran:'<?php echo $input['tahun']; ?>',
                    nama_tabel_database:'esakip_rencana_aksi_pemda'
                },
                dataType: 'json',
                success: function(response) {
                    jQuery('#wrap-loading').hide();
