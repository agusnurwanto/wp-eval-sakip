...
<div class="container-md">
    <div class="cetak">
        <div style="padding: 10px;margin:0 0 3rem 0;">
            <h1 class="text-center" style="margin:3rem;">Dokumen Lhe Akip Internal <br>Pemerintah Daerah<br> Tahun Anggaran <?php echo $input['tahun']; ?></h1>
    ...
    function getTableDokumen() {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                nama_tabel_database: 'esakip_lhe_akip_internal_pemda'
            },
            dataType: 'json',
