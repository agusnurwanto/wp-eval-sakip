    ...
    <div class="cetak">
        <div style="padding: 10px;margin:0 0 3rem 0;">
            ...
            <div class="wrap-table">
                <table id="table_dokumen_laporan_monev_renaksi" cellpadding="2" cellspacing="0" style="font-family:\'Open Sans\',-apple-system,BlinkMacSystemFont,\'Segoe UI\',sans-serif; border-collapse: collapse; width:100%; overflow-wrap: break-word;" class="table table-bordered">
                    <thead>
                        <tr>
