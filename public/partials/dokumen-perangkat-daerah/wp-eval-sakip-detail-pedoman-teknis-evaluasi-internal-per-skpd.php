...
$tipe_dokumen = "pedoman_teknis_evaluasi_internal";
...
$is_administrator = in_array('administrator', $user_roles);
    ...
    $cek_settingan_menu = $wpdb->get_var(
        ...
        WHERE nama_dokumen='Pedoman Teknis Evaluasi Internal'
...
<div class="container-md">
    <div class="cetak">
        <div style="padding: 10px;margin:0 0 3rem 0;">
            <h1 class="text-center" style="margin:3rem;">Dokumen Pedoman Evaluasi Internal <br><?php echo $skpd['nama_skpd'] ?><br> Tahun Anggaran <?php echo $input['tahun']; ?></h1>
            ...
            <div class="wrap-table">
                <table id="table_dokumen_pedoman_teknis_evaluasi_internal" cellpadding="2" cellspacing="0" style="font-family:\'Open Sans\',-apple-system,BlinkMacSystemFont,\'Segoe UI\',sans-serif; border-collapse: collapse; width:100%; overflow-wrap: break-word;" class="table table-bordered">
                    <thead>
                        <tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="tahunForm">
                    ...
                    <button type="submit" class="btn btn-primary" onclick="submit_tahun_pedoman_teknis_evaluasi_internal(); return false">Simpan</button>
                </form>
            </div>
        </div>
    </div>
...
<script>
    ...
    function getTablepedoman_teknis_evaluasi_internal() {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'get_table_pedoman_teknis_evaluasi_internal',
            ...
            success: function(response) {
                ...
                if (response.status === 'success') {
                    jQuery('#table_dokumen_pedoman_teknis_evaluasi_internal tbody').html(response.data);
                } else {
    ...
    function submit_tahun_pedoman_teknis_evaluasi_internal() {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'submit_tahun_pedoman_teknis_evaluasi_internal',
                id: id,
                api_key: esakip.api_key,
    ...
    function edit_dokumen_pedoman_teknis_evaluasi_internal(id) {
        jQuery('#wrap-loading').show();
        jQuery.ajax({
            url: esakip.url,
            type: 'POST',
            data: {
                action: 'get_detail_pedoman_teknis_evaluasi_internal_by_id',
                api_key: esakip.api_key,
                id: id
            },
            dataType: 'json',
    ...
    function hapus_dokumen_pedoman_teknis_evaluasi_internal(id) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'hapus_dokumen_pedoman_teknis_evaluasi_internal',
                api_key: esakip.api_key,
                id: id
            },
            dataType: 'json',
