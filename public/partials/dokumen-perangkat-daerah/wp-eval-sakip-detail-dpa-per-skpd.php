        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="tahunForm">
                    ...
                    <button type="submit" class="btn btn-primary" onclick="submit_tahun_dpa(); return false">Simpan</button>
                </form>
            </div>
        </div>
    </div>
    ...
    function getTabledpa() {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                if (response.status === 'success') {
                    jQuery('#table_dokumen_dpa tbody').html(response.data);
                } else {
                    alert(response.message);
                }
            },
        ...
        if(list.length){
            ...
            jQuery.ajax({
                ...
                data: {
                    ...
                    list: list,
                    tahun_anggaran:'<?php echo $input['tahun'] ?>',
                    nama_tabel_database:'esakip_dpa',
                    id_skpd: <?php echo $id_skpd; ?>
                },
                dataType: 'json',
                success: function(response) {
