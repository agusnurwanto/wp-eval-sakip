...
<style type="text/css">
    ...
    #table_dokumen_tl_lhe_akip_internal th {
        ...
        <div style="padding: 10px;margin:0 0 3rem 0;">
            ...
            <?php if (!$is_admin_panrb && $hak_akses_user) : ?>
                <div style="margin-bottom: 25px;">
                    <button class="btn btn-primary" onclick="tambah_dokumen_tl_lhe_akip_internal();"><i class="dashicons dashicons-plus"></i> Tambah Data</button>                
                    <?php
                    if($status_api_esr){
            ...
            <div class="wrap-table">
                <table id="table_dokumen_tl_lhe_akip_internal" cellpadding="2" cellspacing="0" style="font-family:\'Open Sans\',-apple-system,BlinkMacSystemFont,\'Segoe UI\',sans-serif; border-collapse: collapse; width:100%; overflow-wrap: break-word;" class="table table-bordered">
                    <thead>
                        <tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="tahunForm">
                    ...
                    <button type="submit" class="btn btn-primary" onclick="submit_tahun_tl_lhe_akip_internal(); return false">Simpan</button>
                </form>
            </div>
        </div>
    </div>
...
<script>
    jQuery(document).ready(function() {
        ...
        window.tipe_dokumen = "tl_lhe_akip_internal";
    });
    ...
    function getTabletl_lhe_akip_internal() {
        jQuery('#wrap-loading').show();
        jQuery.ajax({
            url: esakip.url,
            type: 'POST',
            data: {
                action: 'get_table_tl_lhe_akip_internal',
                api_key: esakip.api_key,
            ...
            success: function(response) {
                ...
                if (response.status === 'success') {
                    jQuery('#table_dokumen_tl_lhe_akip_internal tbody').html(response.data);
                } else {
                    alert(response.message);
                }
            },
            error: function(xhr, status, error) {
                jQuery('#wrap-loading').hide();
                console.error(xhr.responseText);
                alert('Terjadi kesalahan saat memuat data dokumen TL LHE AKIP Internal!');
            }
        });
    }
    ...
    function tambah_dokumen_tl_lhe_akip_internal() {
    ...
    function submit_tahun_tl_lhe_akip_internal() {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'submit_tahun_tl_lhe_akip_internal',
                id: id,
                api_key: esakip.api_key,
    ...
    function edit_dokumen_tl_lhe_akip_internal(id) {
        jQuery('#wrap-loading').show();
        jQuery.ajax({
            url: esakip.url,
            type: 'POST',
            data: {
                action: 'get_detail_tl_lhe_akip_internal_by_id',
                api_key: esakip.api_key,
                id: id
            },
            dataType: 'json',
    ...
    function submit_dokumen(that) {
        ...
        let form_data = new FormData();
        form_data.append('action', 'tambah_dokumen_tl_lhe_akip_internal');
        form_data.append('api_key', esakip.api_key);
        form_data.append('id_dokumen', id_dokumen);
    ...
    function hapus_dokumen_tl_lhe_akip_internal(id) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'hapus_dokumen_tl_lhe_akip_internal',
                api_key: esakip.api_key,
                id: id
            },
            dataType: 'json',
        ...
        if(list.length){
            ...
            jQuery.ajax({
                ...
                data: {
                    ...
                    list: list,
                    tahun_anggaran:'<?php echo $input['tahun'] ?>',
                    nama_tabel_database:'esakip_tl_lhe_akip_internal',
                    id_skpd: <?php echo $id_skpd; ?>
                },
                dataType: 'json',
                success: function(response) {
