...
$is_administrator = in_array('administrator', $user_roles);
    ...
    $cek_settingan_menu = $wpdb->get_var(
        ...
        WHERE nama_dokumen='TL LHE AKIP Kemenpan'
...
<div class="container-md">
    <div class="cetak">
        <div style="padding: 10px;margin:0 0 3rem 0;">
            <h1 class="text-center" style="margin:3rem;">Dokumen TL LHE AKIP Kemenpan <br><?php echo $skpd['nama_skpd'] ?><br> Tahun Anggaran <?php echo $input['tahun']; ?></h1>
