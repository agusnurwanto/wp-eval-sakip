...
<div class="container-md">
	<div class="cetak">
		<div style="padding: 10px;margin:0 0 3rem 0;">
			<h1 class="text-center table-title">Dokumen Lain Tahun Anggaran <?php echo $input['tahun']; ?></h1>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="tahunForm">
					...
					<button type="submit" class="btn btn-primary" onclick="submit_tahun_dokumen_lain(); return false">Simpan</button>
				</form>
			</div>
		</div>
	</div>
...
<script>
	...
	function submit_tahun_dokumen_lain() {
    ...
    function hapus_tahun_dokumen_lainnya(id) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'hapus_tahun_dokumen_lainnya',
                api_key: esakip.api_key,
                id: id
            },
            dataType: 'json',
