...
$detail_pengukuran_kinerja = $this->functions->generatePage(array(
	'nama_page' => 'Halaman Detail Dokumen Pengukuran Kinerja ' . $input['tahun'],
	'content' => '[dokumen_detail_pengukuran_kinerja tahun=' . $input["tahun"] . ']',
	'show_header' => 1,
	'no_key' => 1,
	'post_status' => 'private'
));
...
foreach ($unit as $kk => $vv) {
	...
	$tbody .= "<td style='text-transform: uppercase;'><a target='_blank' href='" . $detail_pengukuran_kinerja['url'] . '&id_skpd=' . $vv['id_skpd'] . "'>" . $vv['nama_skpd'] . "</a></td>";
...
<div class="container-md">
	<div class="cetak">
		<div style="padding: 10px;margin:0 0 3rem 0;">
			<h1 class="text-center table-title">Dokumen Pengukuran Kinerja Tahun <?php echo $input['tahun']; ?></h1>
