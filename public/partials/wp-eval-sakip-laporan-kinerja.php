...
$detail_laporan_kinerja = $this->functions->generatePage(array(
	'nama_page' => 'Halaman Detail Dokumen Laporan Kinerja ' . $input['tahun'],
	'content' => '[dokumen_detail_laporan_kinerja tahun=' . $input["tahun"] . ']',
	'show_header' => 1,
	'no_key' => 1,
	'post_status' => 'private'
));
...
foreach ($unit as $kk => $vv) {
	...
	$tbody .= "<td style='text-transform: uppercase;'><a target='_blank' href='" . $detail_laporan_kinerja['url'] . '&id_skpd=' . $vv['id_skpd'] . "'>" . $vv['nama_skpd'] . "</a></td>";
