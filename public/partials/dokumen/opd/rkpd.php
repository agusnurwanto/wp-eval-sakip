...
<script>
    ...
    function getTableRkpd() {
        ...
        jQuery.ajax({
            ...
            success: function(response) {
                ...
                console.log(response);
                if (response.status === 'success') {
                    jQuery('#table_dokumen_rkpd tbody').html(response.data);
                } else {
                    alert(response.message);
                }
            },
    ...
    function edit_dokumen_rkpd(id) {
        jQuery('#wrap-loading').show();
        jQuery.ajax({
            url: esakip.url,
            type: 'POST',
            data: {
                action: 'get_detail_rkpd_by_id',
                api_key: esakip.api_key,
                id: id
            },
            dataType: 'json',
    ...
    function submit_dokumen(that) {
        ...
        form_data.append('action', 'tambah_dokumen_rkpd');
    ...
    function hapus_tahun_dokumen_rkpd(id) {
        if (!confirm('Apakah Anda yakin ingin menghapus dokumen ini?')) {
            return;
        }
        jQuery('#wrap-loading').show();
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'hapus_tahun_dokumen_rkpd',
                api_key: esakip.api_key,
                id: id
            },
            dataType: 'json',
