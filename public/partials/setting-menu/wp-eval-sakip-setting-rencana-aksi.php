...
<div class="cetak">
	...
	<h1 class="text-center" style="margin:3rem;">Halaman Pengaturan Rencana Aksi <br>Tahun Anggaran <?php echo $tahun_anggaran; ?></h1>
		<table id="data_pengaturan_rencana_aksi_table" cellpadding="2" cellspacing="0" style="font-family:\'Open Sans\',-apple-system,BlinkMacSystemFont,\'Segoe UI\',sans-serif; border-collapse: collapse; width:100%; overflow-wrap: break-word;" class="table table-bordered">
		...
		jQuery.ajax({
			...
			success: function(response) {
				...
				if (response.status === 'success') {
					jQuery('#data_pengaturan_rencana_aksi_table tbody').html(response.data);
				} else {
