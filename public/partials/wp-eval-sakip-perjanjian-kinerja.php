...
$detail_perjanjian_kinerja = $this->functions->generatePage(array(
	'nama_page' => 'Halaman Detail Dokumen Perjanjian Kinerja ' . $input['tahun'],
	'content' => '[dokumen_detail_perjanjian_kinerja tahun=' . $input["tahun"] . ']',
	'show_header' => 1,
	'no_key' => 1,
	'post_status' => 'private'
));
...
foreach ($unit as $kk => $vv) {
	...
	$tbody .= "<td style='text-transform: uppercase;'><a target='_blank' href='" . $detail_perjanjian_kinerja['url'] . '&id_skpd=' . $vv['id_skpd'] . "'>" . $vv['nama_skpd'] . "</a></td>";
