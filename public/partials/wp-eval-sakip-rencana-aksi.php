...
$detail_rencana_aksi = $this->functions->generatePage(array(
	'nama_page' => 'Halaman Detail Dokumen Rencana Aksi ' . $input['tahun'],
	'content' => '[dokumen_detail_rencana_aksi tahun=' . $input["tahun"] . ']',
	'show_header' => 1,
	'no_key' => 1,
	'post_status' => 'private'
));
...
foreach ($unit as $kk => $vv) {
	...
	$tbody .= "<td style='text-transform: uppercase;'><a target='_blank' href='" . $detail_rencana_aksi['url'] . '&id_skpd=' . $vv['id_skpd'] . "'>" . $vv['nama_skpd'] . "</a></td>";
...
<div class="container-md">
	<div class="cetak">
		<div style="padding: 10px;margin:0 0 3rem 0;">
			<h1 class="text-center table-title">Dokumen Rencana Aksi Tahun <?php echo $input['tahun']; ?></h1>
