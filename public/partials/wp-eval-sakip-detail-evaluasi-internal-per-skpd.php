...
<div class="container-md">
    <div class="cetak">
        <div style="padding: 10px;margin:0 0 3rem 0;">
            <h1 class="text-center" style="margin:3rem;">Dokumen Evaluasi Internal <br><?php echo $skpd['kode_skpd'] . ' ' . $skpd['nama_skpd'] ?><br> Tahun Anggaran <?php echo $input['tahun']; ?></h1>
...
<script>
    ...
    function getTableTahun() {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'get_table_tahun_evaluasi_internal',
    ...
    function getTableEvaluasiInternal() {
        jQuery('#wrap-loading').show();
        jQuery.ajax({
            url: esakip.url,
            type: 'POST',
            data: {
                action: 'get_table_evaluasi_internal',
                api_key: esakip.api_key,
                id_skpd: <?php echo $id_skpd; ?>,
            ...
            success: function(response) {
                ...
                console.log(response);
                if (response.status === 'success') {
                    jQuery('#table_dokumen_evaluasi_internal tbody').html(response.data);
                } else {
                    alert(response.message);
                }
            },
            error: function(xhr, status, error) {
                jQuery('#wrap-loading').hide();
                console.error(xhr.responseText);
                alert('Terjadi kesalahan saat memuat data Evaluasi Internal!');
            }
        });
    }
    ...
    function edit_dokumen_evaluasi_internal(id) {
        jQuery('#wrap-loading').show();
        jQuery.ajax({
            url: esakip.url,
            type: 'POST',
            data: {
                action: 'get_detail_evaluasi_internal_by_id',
                api_key: esakip.api_key,
                id: id
            },
            dataType: 'json',
    ...
    function hapus_dokumen_evaluasi_internal(id) {
        ...
        jQuery.ajax({
            ...
            type: 'POST',
            data: {
                action: 'hapus_dokumen_evaluasi_internal',
                api_key: esakip.api_key,
                id: id
            },
            dataType: 'json',
